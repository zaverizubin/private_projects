...
public class McqMultipleStrategy extends BaseQuestionStrategy{

    public McqMultipleStrategy(final SubmitAnswerReqDTO submitAnswerReqDto, final Question question,
    ...
    public int score() {
        ...
        return this.question.getScore() * (matchCount / correctAnswerOptions.size());
    }
}
