...
export class OrganizationController {
  ...
  @ApiResponse({ ...OrganizationResponseCodes.CREATED, type: String })
  ...
  update(
    ...
    return this.organizationService.updateOrganization(id, organizationReqDto);
  }
  ...
  @HttpCode(200)
  @Get(':id')
  async findOne(@Param('id') id: string): Promise<OrganizationRespDto> {
  ...
  @HttpCode(200)
  @Get(':id/users')
  async getUsers(@Param('id') id: string): Promise<OrganizationUserRespDto[]> {
